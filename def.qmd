...
<img src="/assets/img/bbob-biobj-ext.png" alt="Functions in the bbob-biobj-ext suite" width="100%">
...
for (let i = 1; i <= 92; i++) {
if (i % 10 == 1) {
jump.appendChild(document.createElement('div'));
}
var elemA = document.createElement('a');
elemA.setAttribute("href","#F" + i);
if (i < 10) {
elemA.innerHTML = "F<sub>" + i + "&nbsp;&nbsp;</sub> ";
}
else {
elemA.innerHTML = "F<sub>" + i + "</sub> ";
}
jump.appendChild(elemA);
}
</script>
