...
Based on a 2-D grid in the search space, the dominance rank ratio of each grid point is the ratio of all grid points that dominate it (Fonseca, 1995, p. 71ff.). The plot uses a logarithmic color scale with the overall non-dominated points shown in yellow.
</div>
